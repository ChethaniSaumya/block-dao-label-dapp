...
# Let's provide some translations for the missing fields automatically using a dictionary
translations = {
...
lines = ["  // --- Remaining form & placeholder translations ---"]
for m in missing:
...
# Split content by '};' and only modify the LAST ONE
left, sep, right = i18n_content.rpartition('};')
content_new = left + block + right
